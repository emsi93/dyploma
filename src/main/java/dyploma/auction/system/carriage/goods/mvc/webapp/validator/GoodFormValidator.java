...
@Component("goodFormValidator")
@Scope("singleton")
public class GoodFormValidator implements Validator{
	...
	public boolean supports(Class<?> clazz) {
		...
		return GoodModel.class.equals(clazz);
	}

	public void validate(Object target, Errors errors) {
		// TODO Auto-generated method stub
		
		GoodModel goodModel = (GoodModel)target;
		...
		ValidationUtils.rejectIfTooLong(errors, "title",
				goodModel.getTitle(), 50, TITLE_TOO_LONG);
