...
@Component("noteAndCommentFormValidator")
@Scope("singleton")
public class NoteAndCommentFormValidator implements Validator{

	private static final String OBLIGATORY_FIELD_ERROR_MSG = "Pole jest wymagane.";
	
	public boolean supports(Class<?> clazz) {
		// TODO Auto-generated method stub
		return NoteAndComment.class.equals(clazz);
	}

	public void validate(Object target, Errors errors) {
		// TODO Auto-generated method stub
		ValidationUtils.rejectIfEmpty(errors, "note",
				OBLIGATORY_FIELD_ERROR_MSG);
		ValidationUtils.rejectIfEmpty(errors, "comment",
				OBLIGATORY_FIELD_ERROR_MSG);
	}
